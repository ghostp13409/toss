...
- **Config Options**: Customizable props, settings, themes, colors, and layouts and other settings to tailor the experience to your preferences with config files.
